  ...
  return (
    <nav className="header">
      <div className="header__logo">
        ...
        <h3 className="logoText">BookTrip</h3>
      </div>

      <div className="header__section">
         {/* Button to dispatch the profile action */}
        <NavLink to={"/"} className="header__button" >
          ...
          >
            ...
            />
            {/* SVG path for the profile icon */}
          </svg>
        </NavLink>
         {/* Button to dispatch the balance action */}
        <NavLink to={"/balance"} className="header__button" >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div className="header__sectionShort">
         {/* Button to dispatch the menu  action for mobile view */}
        <button className="header__button" onClick={() => dispatch(menu())}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
